...
public class Deployment {
     ...
     */
    public static final Class<? extends FRCApplication> robotMain = robot.ChipBunnyBot.class;
    ...
    public static void deploy() throws Exception {
        ...
        int number = robot.ChipBunnyBot.TEAM_NUMBER;
    ...
    public static void layEgg() throws Exception {
        ...
        DepEgg.layEgg(result, new ArtifactDeployer() {
            ...
            public void deployArtifact(Artifact artifact) throws Exception {
                try (DepRoboRIO.RIOShell rshell = DepRoboRIO.discoverAndVerify(robot.ChipBunnyBot.TEAM_NUMBER)) {
